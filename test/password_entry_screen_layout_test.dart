...
void main() {
  testWidgets('PasswordEntryScreen fits 5-inch screen (360x640) without scrolling', (WidgetTester tester) async {
    ...
    // Pump the PasswordEntryScreen inside a MaterialApp with AppTheme
    await tester.pumpWidget(
      MaterialApp(
        theme: AppTheme.lightTheme,
        home: const PasswordEntryScreen(phoneNumber: "+94777123456"),
      ),
    );

    // Let the initial animations settle
    ...
    debugPrint("PasswordEntryScreen max scroll extent for 360x640: $maxScrollExtent");
  ...
  testWidgets('PasswordEntryScreen fits 4-inch screen (320x568) without scrolling', (WidgetTester tester) async {
    ...
    debugPrint("PasswordEntryScreen max scroll extent for 320x568: $maxScrollExtent");
